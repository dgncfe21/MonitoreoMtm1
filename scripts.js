...
var cars_Ref = firebase.database().ref('/LAMPARAS_E1_MAT');


var dataConductores = firebase.database().ref('/LAMPARAS_E1_MAT');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E1_MAT');
